...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             .appName("Indian Elections")
             .master("local[*]")  
             .config("spark.jars.packages",
                     "org.apache.spark:spark-sql-kafka-0-10_2.13:3.5.0")  
             .config("spark.jars",
                     "D:\Real_Time_Data_Driven_Voting_System\postgresql-42.7.1.jar")  
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "D:\Real_Time_Data_Driven_Voting_System\checkpoints\checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "D:\Real_Time_Data_Driven_Voting_System\checkpoints\checkpoint2") \
        .outputMode("update") \
        .start()
